...
consequence of the spicules slipping (see Figure~\sout{\textcolor{blue}{1}}\hypersetup{linkcolor=red}\ref{fig:slip2}\hypersetup{linkcolor=blue}$\subf{B}$)
...
This total length is shown marked as~$S$ in Figure~\sout{\textcolor{blue}{1}}\hypersetup{linkcolor=red}\ref{fig:slip2}\hypersetup{linkcolor=blue}$\subf{B}$$\subf{ii}.2$.
The jumps appear, e.g., as the discontinuities in the green curve
shown in Figure~\sout{\textcolor{blue}{1}}\hypersetup{linkcolor=red}\ref{fig:slip2}\hypersetup{linkcolor=blue}$\subf{B}$$\subf{iii}$.  \sout{We then
showed}\textcolor{red}{It was further shown} that the jumps and the force-drop events (which appear, e.g.,
as the discontinuities in the blue curve in Figure~\sout{\textcolor{blue}{1}}\hypersetup{linkcolor=red}\ref{fig:slip2}\hypersetup{linkcolor=blue}$\subf{B}$$\subf{iii}$)
...
in the fixed-fixed (FF) setup (see Figure~\sout{\textcolor{blue}{1}}\hypersetup{linkcolor=red}\ref{fig:slip2}\hypersetup{linkcolor=blue}$\subf{A}$).
...
(see Figure~\sout{\textcolor{blue}{1}}\hypersetup{linkcolor=red}\ref{fig:slip2}\hypersetup{linkcolor=blue}$\subf{B}$$\subf{ii}.2$), and we refer
...
the experimental measurements,}\textcolor{red}{We find that the values of~$\mu_0$, which were chosen to match our model's prediction with the experimental measurements as closely as possible,} is quite consistent with the values
...
(see Figure~\sout{\textcolor{blue}{1}}\hypersetup{linkcolor=red}\ref{fig:slip2}\hypersetup{linkcolor=blue}}{$\subf{B}$$\subf{ii}.1$}{).}
...
({see Figure~\sout{\textcolor{blue}{1}}\hypersetup{linkcolor=red}\ref{fig:slip2}\hypersetup{linkcolor=blue}}{$\subf{B}.(ii).2$}).
...
In each of the subfigures of Figures~\ref{fig:Cat1}--\ref{fig:Cat3},
...
are{~}$\approx$ 11 and 45~$\rm\mu m$, respectively.
...
450~$\rm\mu m$) \textcolor{red}{would be needed}. The resolution in our SEM images with such HFW would
be limited to around 0.29~$\rm\mu m$. Considering that the outer-layer
thickness of a spicule is typically 0.4~$\rm\mu m$~\cite{monn2015new}
...
0.04~$\rm\mu m$ is required. Therefore, the competition between the
...
to the measurements of~\cite{Sayaka2021Sawtooth},} \textcolor{red}{the values of $\mu_0$, which were chosen to match our model's predictions as closely as possible with the measurements of~\cite{Sayaka2021Sawtooth},} are quite
...
afterwards.
\item Our preliminary research suggests that there can exist \sout{a different}\textcolor{red}{an alternative}
...
one that does. However, \sout{that different}\textcolor{red}{this alternative} model also contains assumptions
