...
measured sawtooth patterns. We find that the sawtooth pattern in the
...
is roughly in the 5--10 nm range (not identifiable in the SEM image)~\cite{weaver2007hierarchical}.\label{fig:lamellar}}
\end{figure}
...
the~$-\physe_2$ direction at a rate of~$1~\rm\mu m/sec$. We denote
