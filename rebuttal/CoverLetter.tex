...
(i) In \S 1 of the revised manuscript,  we now explicitly state that, in our model, each of the configurations for which we derive quantitative predictions are taken to be in static equilibrium.
...
\textit{The loading phase of the tests were conducted by moving the MTS in
 the~$-\physe_2$ direction at an average velocity of ~$\approx 1~\mu\rm m/sec$. 
